...
# Varianta recursiva - cea cu liste de cel putin 3 elemente
...
def problema(lista,poz):
    ...
    while True:
        ...
        while cond_consistent(candidat):
            ...
            if conditie_solutie(candidat) == True:
