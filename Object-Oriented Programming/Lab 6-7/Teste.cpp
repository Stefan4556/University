...
void teste_repo() {
	...
	Repository_filme_file repo("C:/Users/stefan/source/repos/Lab 6-7/Lab 6-7/teste.txt");
	try {
	...
	Repository_filme_file repo1("C:/Users/stefan/source/repos/Lab 6-7/Lab 6-7/teste.txt");
	repo1 = repo1;
	...
	Repository_filme_file repo2("C:/Users/stefan/source/repos/Lab 6-7/Lab 6-7/teste.txt");
	repo2.nume_fisier = "";
	try {
...
void teste_service() {
	...
	std::ofstream g("C:/Users/stefan/source/repos/Lab 6-7/Lab 6-7/teste.txt");
...
void teste_cos() {
	...
	cos.genereaza_cos(repo.get_all(),2);
	assert(cos.numar_filme() == 2);
	try {

		cos.genereaza_cos(repo.get_all(),12);
		assert(false);
	}
	catch (CosError) {
	...
	cos.exporta("C:/Users/stefan/Desktop/test.txt");
...
void teste_service_cos() {
	...
	srv.exporta_fisier("C:/Users/stefan/Desktop/test.txt");
