...
public class FriendshipDB extends AbstractRepoDB<Tuple<Long,Long>, Friendship> {
     ...
     */
    @Override
    protected void saveSet(PreparedStatement ps, Friendship entity) {
     ...
     * @param ps - Prepared statement
     * @param longLongTuple - The id of the friendship
     */
    @Override
    protected void deleteSet(PreparedStatement ps, Tuple<Long, Long> longLongTuple) {
