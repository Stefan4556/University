bits 32
;Sa se scrie un program care citeste cifre pana cand se citeste caracterul 'S'(din consola).
;Sa se formeze si sa se afiseze cel mai mic numar format doar cu cifrele impare citite de la 
...
segment data use32 class=data
    ...
    fisier_output db "output_S.txt",0
    acces_fisier db "w",0
    lungime dd 0
    copie_lungime dd 0
    variabila dd 0
